...
#define ROS_PARAM_LIST                                                                                                 \
  ...
  LIST_ENTRY(camera_type, "Specifies which camera is being used", std::string, std::string("kinect"))                                      \
  ...
  LIST_ENTRY(body_tracking_cpu, "True if body tracking should work on CPU", bool, false)                               \
